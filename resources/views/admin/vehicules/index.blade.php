      ...
      <div class="container-fluid">
          ...
          <table class="table table-bordered table-striped">
              ...
              <tr>
                  ...
                  <td>{{ $v->Annee_Veh}}</td>
                  <td>{{ $v->Couleur_Veh}}</td>
                  <td><a href="{{route('admin.vehicules.index', $v->id)  }}" class="btn btn-info">Edit</a> 
                  &nbsp;&nbsp;
                  <a href="javascript:void(0)" onclick="$(this).parent().find('form').submit(); return confirm('Are you sure?')" class="btn btn-danger">Delete</a><form action="{{ route('admin.vehicules.destroy', $v->id )}}" method="post">
                      @method('DELETE')
