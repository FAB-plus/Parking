...
<section class="content">
        <div class="jumbotron">
            <div class="card">
                <div class="card-body">
                <form method="post" action="{{ route('controler.ordersdet.store')}}" align="center" enctype="multipart/form-data"><input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="form-group" align="center">
                                    ...
                                    <div class="col-md-3"><input type="text" name="orderId"  class="form-control"  value="{{$orders->id}}"></div>
                                    <div class="clearfix"></div>
                                    <label class="col-md-3">Prix Unitaire</label>
                                    <div class="col-md-3"><input type="text" name="unitPrice"  class="form-control" placeholder="Enter le prix" ></div>
                                    <div class="clearfix"></div>
