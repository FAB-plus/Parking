...
<section class="content">
        <div class="jumbotron">
            <div class="card">
                <div class="card-body">
                <form method="post" action="{{ route('controler.visites.store')}}" align="center" enctype="multipart/form-data"><input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="form-group" align="center">
                            
                                    <label class="col-md-3">Derniere Visite</label>
                                    <div class="col-md-3"><input type="date" name="date_visite"  class="form-control" placeholder="Enter la date" ></div>
                                    <div class="clearfix"></div>
                                    <label class="col-md-3">Prochaine visite</label>
                                    <div class="col-md-3"><input type="date" name="Expiration_visite" class="form-control" placeholder="Enter la date" ></div>
                                    <div class="clearfix"></div>
