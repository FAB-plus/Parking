...
<section class="content">
        <div class="jumbotron">
            <div class="card">
                <div class="card-body">
                <form method="post" action="{{ route('controler.products.update', $products->id)}}" align="center" enctype="multipart/form-data">
                @method('PUT')
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="form-group" align="center">
                                    ...
                                    <option value="{{ ($b->categoryName) }}">{{ ($b->categoryName) }}</option>
                                    @endforeach
                                    </select>
                                    </div>
